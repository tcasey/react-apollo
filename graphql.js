  ...
  function wrapWithApolloComponent(WrappedComponent) {
    ...
    var GraphQL = (function(_super) {
      ...
      GraphQL.prototype.componentDidMount = function() {
        ...
        if (this.type === parser_1.DocumentType.Mutation) return;
        if (!this.shouldSkip(this.props)) {
      ...
      GraphQL.prototype.componentWillReceiveProps = function(
        ...
        if (
          this.type === parser_1.DocumentType.Subscription &&
      ...
      GraphQL.prototype.calculateResultProps = function(result) {
        var name =
          this.type === parser_1.DocumentType.Mutation ? 'mutate' : 'data';
      ...
      GraphQL.prototype.fetchData = function() {
        ...
        if (
          operation.type === parser_1.DocumentType.Mutation ||
      ...
      GraphQL.prototype.dataForChild = function() {
        ...
        if (this.type === parser_1.DocumentType.Subscription) {
          ...
          if (errors && errors.length > 0) {
            error_1 = new apollo_client_1.ApolloError({
