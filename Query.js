...
var Query = (function(_super) {
  ...
  function Query(props, context) {
    ...
    _this.initializeQueryObservable = function(props) {
      ...
      invariant(
        operation.type === parser_1.DocumentType.Query,
    ...
    _this.getQueryResult = function() {
      ...
      return __assign(
        ...
        observableQueryFields(_this.queryObservable),
      );
    };
    invariant(
      !!context.client,
  ...
  Query.prototype.fetchData = function() {
    var _a = this.props,
      ...
      ssr = _a.ssr,
      opts = __rest(_a, ['children', 'ssr']);
    var fetchPolicy = opts.fetchPolicy;
    if (ssr === false) return false;
    if (fetchPolicy === 'network-only' || fetchPolicy === 'cache-and-network') {
      fetchPolicy = 'cache-first';
    }
    var observable = this.client.watchQuery(
      __assign({}, opts, { fetchPolicy: fetchPolicy }),
    );
