(function(a, b) {
  ...
  k(q);
  var r = q.ObservableQueryRecycler,
    s = l(function(a, c) {
      var e =
        (m && m.__extends) ||
        (function() {
          ...
          (b.prototype.getQueryRecycler = function(a) {
            return (
              this.recyclers.has(a) ||
                this.recyclers.set(a, new q.ObservableQueryRecycler()),
          ...
          return (
            ...
            (d.initializeQueryObservable = function(a) {
              var b = a.variables,
                ...
                j = u.parser(i);
              e(
                j.type === u.DocumentType.Query,
                'The <Query /> component requires a graphql query, but got a ' +
                  (j.type === u.DocumentType.Mutation
                    ? 'mutation'
                    : 'subscription') +
                  '.',
              );
          ...
          n = (function(i) {
            ...
            return (
              ...
              (n.prototype.componentDidMount = function() {
                if (
                  ((this.hasMounted = !0),
                  this.type !== u.DocumentType.Mutation) &&
                ...
                if (
                  ...
                  return (
                    ...
                    this.client !== c && this.client !== b.client
                      ...
                      : this.type === u.DocumentType.Mutation
                        ? void 0
                        : this.type === u.DocumentType.Subscription &&
                          h.shouldResubscribe &&
              ...
              (n.prototype.componentWillUnmount = function() {
                if (this.type === u.DocumentType.Query) {
              ...
              (n.prototype.calculateResultProps = function(a) {
                var b =
                  this.type === u.DocumentType.Mutation ? 'mutate' : 'data';
                h.name && (b = h.name);
              ...
              (n.prototype.setInitialProps = function() {
                if (this.type !== u.DocumentType.Mutation) {
              ...
              (n.prototype.fetchData = function() {
                ...
                if (
                  C.type === u.DocumentType.Mutation ||
                  C.type === u.DocumentType.Subscription
                )
                  return !1;
              ...
              (n.prototype.subscribeToQuery = function() {
                ...
                if (!this.querySubscription) {
                  var b = function(b) {
                      a.type === u.DocumentType.Subscription &&
        ...
        k = (function(f) {
          ...
          return (
            ...
            (i.prototype.render = function() {
              var e = this;
              return b.createElement(p.default, null, function(f) {
                var g = c({}, e.props, {
                  client: f,
  ...
  var A = l(function(a, b) {
      ...
      Object.defineProperty(b, '__esModule', { value: !0 }),
        (b.getDataFromTree = n.default),
        c(n),
        (b.ApolloConsumer = p.default),
        c(p),
        (b.ApolloProvider = t.default),
        c(t),
        (b.Query = x.default),
        c(x),
        (b.graphql = y.default),
        c(y),
        (b.withApollo = z.default),
        (b.compose = j);
    }),
    B = k(A),
    C = A.getDataFromTree,
